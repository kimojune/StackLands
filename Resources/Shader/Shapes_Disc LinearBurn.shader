...
SubProgram "d3d11 " {
Keywords { "INNER_RADIUS" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "INNER_RADIUS" "SECTOR" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "INSTANCING_ON" "SECTOR" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "INNER_RADIUS" "INSTANCING_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "INNER_RADIUS" "INSTANCING_ON" "SECTOR" }
"// shader disassembly not supported on DXBC"
}
}
Program "fp" {
